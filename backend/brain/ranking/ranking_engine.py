...
# NOTE: backend/brain/models/destination_ranking/ranking_config.json now describes the
# *live* OpportunityRankingEngine's weight schema (src/partner_discovery/ranking.py),
# which powers POST /predict/market-opportunity — not this module's schema. This
# DestinationRankingEngine is not currently wired into any live endpoint, so its
# DEFAULT_WEIGHTS below stays hardcoded and is intentionally NOT read from that file.
DEFAULT_WEIGHTS = {
    "demand": 0.30,
    "growth": 0.20,
    "access": 0.15,
